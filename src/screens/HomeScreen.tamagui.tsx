...
export default function HomeScreen({ navigation }: HomeScreenProps) {
  ...
  const responsiveStyles = useMemo(() => ({
    ...
    statValueSize: isSmallScreen ? '$5' : isLargeScreen ? '$7' : '$6',
    statLabelSize: isSmallScreen ? '$1' : isLargeScreen ? '$2' : '$1',
      ...
      <NavigationBar>
        <XStack alignItems="center" gap="$xs">
          ...
          <Card
            ...
            borderRadius="$1"
          >
            <Text fontSize="$1" fontWeight="700" color="white" letterSpacing={0.5}>
              BETA
            </Text>
          </Card>
        </XStack>
