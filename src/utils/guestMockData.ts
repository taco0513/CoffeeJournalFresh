  ...
  return [
    {
      ...
      flavorNotes: [
        { id: '1', level: 1, value: 'Fruit', koreanValue: '과일' },
        { id: '2', level: 2, value: 'Berry', koreanValue: '베리류' },
        { id: '3', level: 3, value: 'Blueberry', koreanValue: '블루베리' },
        { id: '4', level: 1, value: 'Chocolate', koreanValue: '초콜릿' },
      ],
      sensoryAttributes: {
        body: 4,
        acidity: 4,
    ...
    },
    {
      ...
      flavorNotes: [
        { id: '1', level: 1, value: 'Floral', koreanValue: '꽃' },
        { id: '2', level: 2, value: 'Jasmine', koreanValue: '자스민' },
        { id: '3', level: 1, value: 'Fruit', koreanValue: '과일' },
        { id: '4', level: 2, value: 'Stone Fruit', koreanValue: '핵과류' },
        { id: '5', level: 3, value: 'Peach', koreanValue: '복숭아' },
      ],
      sensoryAttributes: {
        body: 3,
        acidity: 5,
    ...
    },
    {
      ...
      flavorNotes: [
        { id: '1', level: 1, value: 'Fruit', koreanValue: '과일' },
        { id: '2', level: 2, value: 'Berry', koreanValue: '베리류' },
        { id: '3', level: 3, value: 'Strawberry', koreanValue: '딸기' },
        { id: '4', level: 2, value: 'Tropical', koreanValue: '열대과일' },
      ],
      sensoryAttributes: {
        body: 4,
        acidity: 3,
    ...
    },
    {
      ...
      flavorNotes: [
        { id: '1', level: 1, value: 'Fruit', koreanValue: '과일' },
        { id: '2', level: 2, value: 'Berry', koreanValue: '베리류' },
        { id: '3', level: 3, value: 'Black Currant', koreanValue: '블랙커런트' },
        { id: '4', level: 1, value: 'Savory', koreanValue: '세이보리' },
        { id: '5', level: 2, value: 'Tomato', koreanValue: '토마토' },
      ],
      sensoryAttributes: {
        body: 5,
        acidity: 5,
    ...
    },
    {
      ...
      flavorNotes: [
        { id: '1', level: 1, value: 'Fruit', koreanValue: '과일' },
        { id: '2', level: 2, value: 'Citrus', koreanValue: '시트러스' },
        { id: '3', level: 3, value: 'Orange', koreanValue: '오렌지' },
        { id: '4', level: 1, value: 'Chocolate', koreanValue: '초콜릿' },
        { id: '5', level: 1, value: 'Sugar', koreanValue: '당류' },
        { id: '6', level: 2, value: 'Caramel', koreanValue: '캐러멜' },
      ],
      sensoryAttributes: {
        body: 4,
        acidity: 4,
