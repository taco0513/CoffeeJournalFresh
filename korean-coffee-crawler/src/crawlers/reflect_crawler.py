...
class ReflectCrawler(BaseCrawler):
    def __init__(self):
        super().__init__(
            roastery_name="리플렉트커피",
            base_url="https://reflect-coffee.co.kr",
            use_selenium=False
        )
    ...
    def parse_coffee_detail(self, url: str) -> Optional[Coffee]:
        ...
        try:
            ...
            if not weight:
                weight_spans = soup.select('span.ec-product-qty-qty, span.weight')
